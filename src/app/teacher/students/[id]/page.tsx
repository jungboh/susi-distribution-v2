  ...
  return (
    <TeacherAppShell classCode={classCode} view="students" title={`${student.name} 학생 상세`}>
      <PageContainer>
        ...
        <StudentDetailTabs
          applicationsPanel={<ConsultationApplicationsPanel studentId={student.id} studentName={student.name} initialApplications={applications} initialChecklist={checklist} />}
